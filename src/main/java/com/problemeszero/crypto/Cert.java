...
//                BigInteger.valueOf(System.currentTimeMillis()),
//                new Date(System.currentTimeMillis() - 1000L * 5),
//                new Date(System.currentTimeMillis() + ExValues.ONE_YEAR),
//                new X500Name("CN=Issuer CA"),
//                caPublicKey);
//
...
//    }
//
//    public static X509Certificate makeV3Certificate(X509Certificate caCertificate, PrivateKey caPrivateKey, PublicKey eePublicKey, String cn)
//            throws GeneralSecurityException, CertIOException, OperatorCreationException
//    {
//        //
//        // create the certificate - version 3
...
//                new Date(System.currentTimeMillis() - 1000L * 5),
//                new Date(System.currentTimeMillis() + ExValues.ONE_YEAR),
//                new X500Principal("CN=Cert " + cn ), eePublicKey);
//
//        //
//        // extensions
//        //
